...
{
    private readonly ILogger<CatalogInitialData> _logger;

    public CatalogInitialData(ILogger<CatalogInitialData> logger)
    {
        _logger = logger;
    }
    ...
    public async Task Populate(IDocumentStore store, CancellationToken cancellation)
    {
        ...
        {
            _logger.LogInformation("[End] Catalog Data Existed");
            return;
        };
            
        session.Store<Product>(GetPreconfiguredProducts());
        await session.SaveChangesAsync(cancellation);
        _logger.LogInformation("[End] Catalog Data Populated");
    }
